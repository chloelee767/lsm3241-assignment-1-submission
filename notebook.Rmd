---
title: "Code used for LSM3241 Assignment 1 (Scenario 2)"
...
# Adds a column mapping probe id to entrez id to a toptable
add_entrez_col <- function (ttable) {
  ...
  ttable[complete.cases(ttable$ENTREZID),]
}
...
```{r}
eset_of_interest1 <- eset[rownames(interesting_genes1),]
eset_of_interest2 <- eset[rownames(interesting_genes2),]
eset_of_interest3 <- eset[rownames(interesting_genes3),]
eset_of_interest4 <- eset[rownames(interesting_genes4),]
eset_of_interest5 <- eset[rownames(interesting_genes5),]
eset_of_interest6 <- eset[rownames(interesting_genes6),]
eset_of_interest7 <- eset[rownames(interesting_genes7),]

heatmap(exprs(eset_of_interest1),
        labCol = eset$treat,
        col       = rev(brewer.pal(10, "RdBu")),
        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map(Effect of genotype in old mice)")
...
#heatmap(exprs(eset_of_interest3),
#        labCol = eset$treat,
#        col       = rev(brewer.pal(10, "RdBu")),
#        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map for genes of interest")
#heatmap(exprs(eset_of_interest4),
#        labCol = eset$treat,
#        col       = rev(brewer.pal(10, "RdBu")),
#        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map for genes of interest")

heatmap(exprs(eset_of_interest5),
        labCol = eset$treat,
        col       = rev(brewer.pal(10, "RdBu")),
        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map(Effect of genotype in both age groups)")

#heatmap(exprs(eset_of_interest6),
#       labCol = eset$treat,
#        col       = rev(brewer.pal(10, "RdBu")),
#        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map for genes of #interest (contrast)")

heatmap(exprs(eset_of_interest7),
        labCol = eset$treat,
        col       = rev(brewer.pal(10, "RdBu")),
        distfun   = function(x) as.dist(1-cor(t(x))),main="heat map(Effect of interaction between genotype and age)")
```
